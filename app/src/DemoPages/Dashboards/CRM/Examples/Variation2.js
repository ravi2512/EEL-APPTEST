                    ...
                    <Row>
                        <Col lg="12" xl="6">
                            <Row>
                                ...
                                <Col md="6" lg="3" xl="6">
                                    <div
                                        className="card mb-3 widget-chart widget-chart2 text-left card-btm-border card-shadow-primary border-primary">
                                        <div className="widget-chat-wrapper-outer">
                                            <div className="widget-chart-content pt-3 pl-3 pb-1">
                                                <div className="widget-chart-flex">
                                                    <div className="widget-numbers">
                                ...
                                <Col md="6" lg="3" xl="6">
                                    <div
                                        className="card mb-3 widget-chart widget-chart2 text-left card-btm-border card-shadow-warning border-warning">
                                        <div className="widget-chat-wrapper-outer">
                                            <div className="widget-chart-content pt-3 pl-3 pb-1">
                                                <div className="widget-chart-flex">
                                                    <div className="widget-numbers">
                                ...
                                <Col md="6" lg="3" xl="6">
                                    <div
                                        className="card mb-3 widget-chart widget-chart2 text-left card-btm-border card-shadow-danger border-danger">
                                        <div className="widget-chat-wrapper-outer">
                                            <div className="widget-chart-content pt-3 pl-3 pb-1">
                                                <div className="widget-chart-flex">
                                                    <div className="widget-numbers">
                                                        ...
                                                        <div className="widget-content-outer">
                                                            <div className="widget-content-wrapper">
                                                                <div className="widget-content-left pr-2 fsize-1">
                                                                    <div
                                                                        className="widget-numbers fsize-3 text-alternate">
                                                                        61%
                                                                    </div>
                                                                </div>
                                        ...
                                        <div className="widget-chart p-0">
                                            <ResponsiveContainer height={192}>
                                                <AreaChart data={data2}
                                                    ...
                                                    <defs>
                                                        <linearGradient id="colorPv2" x1="0" y1="0" x2="0" y2="1">
                                                            <stop offset="10%" stopColor="var(--alternate)"
                                                                  stopOpacity={0.7}/>
                                                            <stop offset="90%" stopColor="var(--alternate)"
                                                                  stopOpacity={0}/>
                                                        </linearGradient>
                                                    </defs>
                                                    <Tooltip/>
                    ...
                    <Row>
                        <Col lg="5">
                            <Row>
                                <Col md="6" lg="12">
                                    <Card
                                        className="card-hover-shadow-2x mb-3 card-btm-border card-shadow-primary border-primary">
                                        <CardHeader className="rm-border pb-0 mt-sm-3 responsive-center">
                                            <div>
                                                <h5 className="menu-header-title text-capitalize fsize-2 text-muted text-left opacity-6">Received
                                                    Messages</h5>
                                            </div>
                                        </CardHeader>
                                        <div className="widget-chart widget-chart2 text-left p-0">
                                            <div className="widget-chat-wrapper-outer">
                                                ...
                                                <div
                                                    className="widget-chart-wrapper widget-chart-wrapper-lg he-auto opacity-3 m-0 p-1">
                                                    <ResponsiveContainer height={114}>
                                                        <AreaChart data={data3}
                                                            ...
                                                            <Area type='monotoneX' dataKey='uv' stroke='var(--primary)'
                                                                  ...
                                                                  fill='var(--primary)' fillOpacity=".08"/>
                                                        </AreaChart>
                                                    </ResponsiveContainer>
                                                </div>
                                            </div>
                                ...
                                <Col md="6" lg="12">
                                    <Card
                                        className="card-hover-shadow-2x mb-3 card-btm-border card-shadow-danger border-danger">
                                        <CardHeader className="rm-border pb-0 mt-sm-3 responsive-center">
                                            <div>
                                                <h5 className="menu-header-title text-capitalize fsize-2 text-muted text-left opacity-6">Sent
                                                    Messages</h5>
                                            </div>
                                        </CardHeader>
                                        <div className="widget-chart widget-chart2 text-left p-0">
                                                    ...
                                                    <ResponsiveContainer height={114}>
                                                        <AreaChart data={data2}
                                                            ...
                                                            <Area type='monotoneX' dataKey='uv' stroke='var(--danger)'
                                                                  strokeOpacity=".8" strokeWidth={3}
                                                                  fill='var(--danger)' fillOpacity=".08"/>
                                                        </AreaChart>
                                                    </ResponsiveContainer>
                                                </div>
                                            </div>
                                ...
                                <CardBody>
                                    <TabContent activeTab={this.state.activeTab2}>
                                        <TabPane tabId="111">
                                            ...
                                            <h6 className="text-muted text-uppercase font-size-md opacity-5 font-weight-normal">Top
                                                Authors</h6>
