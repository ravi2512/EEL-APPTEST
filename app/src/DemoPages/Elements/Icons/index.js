        ...
        return (
            <Fragment>
                <ReactCSSTransitionGroup
                    ...
                    >
                        <TabPane tab='Pe7 Icons' key="1"><Pe7IconsExample/></TabPane>
                        <TabPane tab='FontAwesome' key="2"><FontAwesomeIconsExample/></TabPane>
                        <TabPane tab='Linear Icons' key="3"><LinearIconsExample/></TabPane>
                        <TabPane tab='Ion Icons' key="4"><IonIconsExample/></TabPane>
                        <TabPane tab='Flag Icons' key="5"><FlagIconsExample/></TabPane>
                    </Tabs>
                </ReactCSSTransitionGroup>
            </Fragment>
        );
