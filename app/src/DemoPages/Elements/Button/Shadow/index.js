        ...
        return (
            <Fragment>
                <ReactCSSTransitionGroup
                    ...
                    >
                        <TabPane tab='Solid' key="1"><ButtonsShadowSolid/></TabPane>
                        <TabPane tab='Outline' key="2"><ButtonsShadowOutline/></TabPane>
                        <TabPane tab='Outline 2x' key="3"><ButtonsShadowOutline2x/></TabPane>
                        <TabPane tab='Dashed' key="4"><ButtonsShadowDashed/></TabPane>
                        <TabPane tab='Gradients' key="5"><ButtonsShadowGradients/></TabPane>
                    </Tabs>
                </ReactCSSTransitionGroup>
            </Fragment>
        );
