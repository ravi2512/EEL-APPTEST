        ...
        return (
            <Fragment>
                <ReactCSSTransitionGroup
                    ...
                    >
                        <TabPane tab='Solid' key="1"><ButtonsStandardSolid/></TabPane>
                        <TabPane tab='Outline' key="2"><ButtonsStandardOutline/></TabPane>
                        <TabPane tab='Outline 2x' key="3"><ButtonsStandardOutline2x/></TabPane>
                        <TabPane tab='Dashed' key="4"><ButtonsStandardDashed/></TabPane>
                        <TabPane tab='Gradients' key="5"><ButtonsStandardGradients/></TabPane>
                    </Tabs>
                </ReactCSSTransitionGroup>
            </Fragment>
        );
