...
function (_React$Component) {
  ...
  function DateTimeRangeContainer(props) {
    ...
    _this.onClickContainerHandler = _this.onClickContainerHandler.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleOutsideClick = _this.handleOutsideClick.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.changeVisibleState = _this.changeVisibleState.bind(_assertThisInitialized(_assertThisInitialized(_this)));
