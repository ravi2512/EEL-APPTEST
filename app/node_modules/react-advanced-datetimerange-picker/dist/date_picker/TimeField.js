...
function (_React$Component) {
  ...
  function TimeField(props) {
    ...
    _this.handleHourChange = _this.handleHourChange.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleMinuteChange = _this.handleMinuteChange.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.hourFocus = _this.hourFocus.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.minuteFocus = _this.minuteFocus.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.hourBlur = _this.hourBlur.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.minuteBlur = _this.minuteBlur.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
